...
public class LabeledSwitch extends ToggleableView {
    ...
    private void initProperties(AttributeSet attrs) {
        tarr = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.Toggle, 0, 0);
...
//      Drawing Switch Thumb here
    ...
    public void setDisableToggle(boolean bool) {
        enabled = tarr.getBoolean(R.styleable.Toggle_android_enabled, bool);
    }
}
